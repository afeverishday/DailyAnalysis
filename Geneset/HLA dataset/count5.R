...
result_tot$HLA_type_new <- gsub(':','',result_tot$Allele)


result_tot<-result_tot %>% mutate(
                        ...
                        ifelse(HLA_type_new %in% c("B*1801", "B*1553", "B*1820", "B*4029", "B*4056", "B*4422", "B*4435", "B*5001", "B*1546", 
                         ...
                         ifelse(HLA_type_new %in% c("B*1516", "B*1567", "B*5804", "B*5704", "B*1517", "B*1595", "B*5806", "B*5705", 
                          ...
                          ifelse(HLA_type_new %in% c("B*1501", "B*1505", "B*1530", "B*1548", "B*1578", "B*1596", "B*5202", 
                                                     ...
                                                     "B*1545", "B*1528", "B*1540", "B*1575", "B*1592", "B*4605", "B*7805", "B*1555"),'B62',
                           ifelse(HLA_type_new %in% c("B*0708", "B*0806", "B*1310", "B*1543", "B*1589", "B*2723", "B*3547", "B*3709", "B*4008", 
                                                      "B*4410", "B*4901", "B*5402", "B*8201", "B*0710", "B*0810", "B*1311", "B*1544", "B*1804", 
                                                      "B*2726", "B*3548", "B*3802", "B*4013", "B*4411", "B*4902", "B*5405", "B*8202", "B*0711", 
                                                      "B*0814", "B*1312", "B*1556", "B*1807", "B*2729", "B*3549", "B*3803", "B*4025", "B*4412", 
                                                      "B*4903", "B*5512", "B*8301", "B*0713", "B*0817", "B*1404", "B*1557", "B*1808", "B*3510", 
                                                      "B*3550", "B*3804", "B*4027", "B*4415", "B*5107", "B*5516", "B*9501", "B*0727", "B*1301", 
                                                      "B*1506", "B*1564", "B*1809", "B*3513", "B*3552", "B*3808", "B*4037", "B*4417", "B*5115", 
                                                      "B*5606", "B*0728", "B*1302", "B*1511", "B*1566", "B*1812", "B*3516", "B*3556", "B*3912", 
                                                      "B*4046", "B*4418", "B*5122", "B*5607", "B*0729", "B*1303", "B*1521", "B*1571", "B*1818", 
                                                      "B*3519", "B*3702", "B*3919", "B*4060", "B*4506", "B*5206", "B*5608", "B*0732", "B*1304", 
                                                      "B*1527", "B*1576", "B*2708", "B*3520", "B*3705", "B*3920", "B*4061", "B*4701", "B*5303", 
                                                      "B*5614", "B*0738", "B*1306", "B*1529", "B*1577", "B*2712", "B*3523", "B*3706", "B*3922", 
                                                      "B*4105", "B*4702", "B*5305", "B*5901", "B*0804", "B*1307", "B*1532", "B*1584", "B*2716", 
                                                      "B*3525", "B*3707", "B*3931", "B*4202", "B*4703", "B*5307", "B*6702", "B*0805", "B*1308", 
                                                      "B*1536", "B*1587", "B*2718", "B*3527", "B*3708", "B*4007", "B*4409", "B*4806", "B*5309", "B*7803"),'B-none','others')     
...
result_tot<-result_tot %>% dplyr::mutate(
...
result_tot$Degree<- ifelse((result_tot$Supertype=='others'),NA, result_tot$Degree)
result_tot$Degree<- ifelse((result_tot$Supertype=='A-none'),NA, result_tot$Degree)
result_tot$Degree<- ifelse((result_tot$Supertype=='B-none'),NA, result_tot$Degree)
...
result_tot <- result_tot %>% dplyr::select(Supertype,Degree, Allele, Allele_Count, Allele_Frequency, Country) %>% arrange(Supertype, Allele)
...
write.table(result_tot, "C:/Users/afeve/Documents/Tutorials/Geneset/HLA dataset/output10.txt",
            sep = "\t",
            row.names = F)
